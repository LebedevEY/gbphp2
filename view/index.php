    ...
    <div class="content">
        ...
        <div class="promo">
            <div class="promo__left">
                <img class="promo__image" src="view/img/promo_img.png" alt="promo img">
            </div>
        ...
        <div class="sale center">
            <div class="sale__box">
                <div class="sale__item"><img class="sale__image" src="view/img/sale_item_1.jpg" alt="sale image">
                ...
                <div class="sale__item"><img class="sale__image" src="view/img/sale_item_2.jpg" alt="sale image">
                    <div class="sale__content">
                        <p class="sale__text">hot deal</p>
                        <h3 class="sale__h3">for men</h3>
                    </div>
                </div>
                <div class="sale__item"><img class="sale__image" src="view/img/sale_item_3.jpg" alt="sale image">
                    <div class="sale__content">
            ...
            <div class="sale__item sale__item__box"><img class="sale__image" src="view/img/sale_item_4.jpg"
                                                         alt="sale image">
                <div class="sale__content">
        ...
        <section class="products center">
            ...
            <a href="index.php?c=catalog" class="products__btn">
